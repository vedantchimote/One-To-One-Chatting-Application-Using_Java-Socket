...
//I have made the Hunny as the client
public class Client implements ActionListener {

    // Here the client class almost replicates the server class
    ...
    //here we need only the Socket instance and not the SocketServer
    static Socket s;

    // The DOS and DIS are necessary as in the server class
    static DataInputStream din;
    static DataOutputStream dout;

    Boolean typing;

    // this is the out client class constructor to initiate to enable the chatting
    Client() {
        ...
        //exiting the whole window after clicking on the back button
        l1.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent ae) {
                System.exit(0);
            }
        });
        //displaying the userdp
        ...
        //now adding the extra menu button
        ...
        //Labelling the user to whom we are messaging
        JLabel l3 = new JLabel("Hunny");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // for the clint we need to pass the host ip and the port number set in the constructor
